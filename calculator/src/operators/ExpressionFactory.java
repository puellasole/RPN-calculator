...
public class ExpressionFactory {
	...
	public static Expression createExpression(final String expressionText, final VariablesScope variables) {
	...
	private static Expression createSubExpression(final String token, final Stack<Expression> expressionStack, final VariablesScope variables) {
	...
	private static Expression createVariableExpression(final String token, final VariablesScope variables) {
